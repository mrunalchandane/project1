...
<tr>
	<url:url value="/resources/images/${p.productId}.png" var="url5"></url:url>
	<td><img src="${url5}" height="50" width="50"></td>
	<td>${p.name}</td>
	<td>${p.price }</td>
	...
	<td>
		...
		<url:url value="/addToCart/${p.productId}" var="url"></url:url>
		<a href="${url}"><span class="glyphicon glyphicon-shopping-cart"></a>
		</security:authorize>
